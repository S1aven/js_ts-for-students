...
import {createMessage, getStreetsTitlesGovermentsBuildings, getStreetsTitlesOfHouses} from "./05_02";
...
test("list of streets titles of goverments buildings", () => {
  let streetsNames = getStreetsTitlesGovermentsBuildings(city.governmentBuildings)
